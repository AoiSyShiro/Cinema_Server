...
exports.register = async (req, res) => {
    ...
    try {
        ...
        const newUser = new User({
            ...
            role,
            created_at: new Date(),
            profile_info: { // Thiết lập profile_info mặc định nếu cần
                address: null,
                phone_number: null,
                favorite_movies: [],
                gender: 'Other'
...
exports.getProfile = async (req, res) => {
    ...
    try {
        ...
        res.status(200).json({
            ...
            role: user.role,
            profile_info: {
                gender: user.profile_info?.gender || null, // Sử dụng optional chaining
                address: user.profile_info?.address || null, // Ví dụ trường khác
                phone_number: user.profile_info?.phone_number || null // Ví dụ trường khác
            }
        });
    } catch (err) {
